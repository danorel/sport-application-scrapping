...
from constants.kafka import READY_TO_TRANSFORM_LOAD_GPX_TOPIC
...
def create_initial_dataframe(spark_session):
    ...
    try:
        df = (
            ...
            .option("subscribe", READY_TO_TRANSFORM_LOAD_GPX_TOPIC)
            .option("delimeter", ",")
...
def start_streaming(df):
    ...
    my_query = (
        ...
        .outputMode("append")
        .options(table="gpx", keyspace="sport_streaming")
        .option("checkpointLocation", "/tmp/checkpoint")
        .start()
    )
